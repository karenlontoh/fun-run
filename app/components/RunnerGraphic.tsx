 ...
 * attempting a photorealistic figure.
 */
export function RunnerGraphic({ className = "" }: RunnerGraphicProps) {
  return (
    <svg viewBox="0 0 240 240" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* motion lines */}
      <rect x="10" y="70" width="46" height="10" rx="5" fill="currentColor" opacity="0.35" />
      <rect x="0" y="95" width="60" height="10" rx="5" fill="currentColor" opacity="0.55" />
      <rect x="14" y="120" width="40" height="10" rx="5" fill="currentColor" opacity="0.35" />
